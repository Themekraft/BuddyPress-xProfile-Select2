 ...
 */
class BP_XProfile_Field_Type_Selectbox2 extends BP_XProfile_Field_Type {
    ...
    public function __construct() {
        ...
        $this->name     = _x( 'Drop Down Select2', 'xprofile field type', 'buddypress' );
    ...
    public function edit_field_html( array $raw_properties = array() ) {
        ...
        <select class="xprofile-select2" <?php echo $this->get_edit_field_html_elements( $raw_properties ); ?>>
